...
$semail=$_POST['email'];
 ...
 $query=mysqli_query($con,"update tblstaff set BranchName='$branchname',StaffName='$staffname',StaffMobilenumber='$smobnumber',StaffEmail='$semail' where  ID='$eid'");
    ...
    if ($query) {
    $msg="Le personnel a été modifié avec succès.";
  }
  else
    {
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Modification Personnel</h4>
              ...
              <option value="<?php echo $rw['BranchName'];?>"><?php echo $rw['BranchName'];?></option>
                  <?php } ?>  
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                          <p style="text-align: center;">  <button type="submit" name="submit" class="btn btn-primary">Modifier</button></p>
