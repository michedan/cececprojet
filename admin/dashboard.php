                        ...
                        <div class="row">
							<div class="col-xl-12">
								<div class="page-title-box">
                                    <h4 class="page-title float-left">Tableau de bord</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <a class="text-muted text-uppercase m-b-20" href="total-courier.php">Total Dossiers</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <a class="text-muted text-uppercase m-b-20" href="courierpickup.php">Total Nouveaux Dosssiers</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <a class="text-muted text-uppercase m-b-20" href="shipped.php">Total Dossiers RESA</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    ...
                                    <a class="text-muted text-uppercase m-b-20" href="intransit.php">Total Dossiers RFC</a>
...
?>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    <i class="icon-layers float-right text-muted"></i>
                                    <a class="text-muted text-uppercase m-b-20" href="arriveddes.php">Total Dossiers DEX</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    <i class="icon-paypal float-right text-muted"></i>
                                    <a class="text-muted text-uppercase m-b-20" href="outfordelivery.php">Total Dossiers DG</a>
...
?>
                            <div class="col-md-6 col-xl-3">
                                <div class="card-box tilebox-one">
                                    <i class="icon-chart float-right text-muted"></i>
                                    <a class="text-muted text-uppercase m-b-20" href="delivered.php">Total Dossiers Finalisés</a>
