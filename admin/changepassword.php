...
return true;
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">MODIFICATION MOT DE PASSE</h4>
   ...
   <p style="font-size:16px; color:red" align="center"> <?php if($msg){
    echo $msg;
                                   ...
                                   <h4 class="header-title m-t-0 m-b-30">Changer le mot de passe</h4>
...
?>
                                    ...
                                    <div class="form-group row">
                                        <label for="example-search-input" class="col-2 col-form-label"> Confirmer le mot de passe</label>
                                        <div class="col-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                          <p style="text-align: center;">  <button type="submit" name="submit" class="btn btn-primary">Changer</button></p>
