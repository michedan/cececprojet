...
$status=1;
 $query=mysqli_query($con,"insert into tblstaff(BranchName,StaffName,StaffMobilenumber,StaffEmail,StaffPassword,status) value('$branchname','$staffname','$smobnumber','$semail','$spassword','$status')");
    ...
    if ($query) {
    $msg="Le personnel a été ajouté avec succès.";
  }
  else
    {
  ...
  success: function(data){
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="page-title-box">
                                    <h4 class="page-title float-left">Ajout Personnel</h4>
   ...
   <p style="font-size:16px; color:Black" align="center"> <?php if($msg){
    echo $msg;
                                   ...
                                   <h4 class="header-title m-t-0 m-b-30">Information Personnel</h4>
      ...
      <?php $query=mysqli_query($con,"select * from  tblbranch");
              ...
              <option value="<?php echo $row['BranchName'];?>"><?php echo $row['BranchName'];?></option>
                  <?php } ?>  
                                    ...
                                    <div class="form-group row">
                                        <label for="example-search-input" class="col-2 col-form-label">Nom Personnel</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="" id="" name="staffname" required="true">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-search-input" class="col-2 col-form-label">Contact Personnel</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="" id="" name="mobilenumber" maxlength="10" required="true">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="example-email-input" class="col-2 col-form-label">Email Personnel</label>
                                        <div class="col-10">
                     <input class="form-control" type="email" onblur="checkstaffemail(this.value)" id="emailid" name="email" required="true">
                            <span id="chkeml"></span>
                                    ...
                                    <div class="form-group row">
                                        <label for="example-url-input" class="col-2 col-form-label">MDP Personnel</label>
                                        <div class="col-10">
                    ...
                    <button type="submit" name="submit" class="btn btn-primary" id="submit">Enregistrer</button></p>
