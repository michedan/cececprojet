...
if(isset($_POST['submit']))
  {
   ...
   $query.=mysqli_query($con, "update  tblcourier set Status='$status' where ID='$cid'");
    if ($query) {
    $msg="Remarque et Statut enregistrés avec succès.";
  }
  else
    {
                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title">Informations Dossier</h4>
 <?php if($msg){?>                                   
<div class="alert alert-success" role="alert">
<strong>C'est Okay!</strong> <?php echo $msg;?>
</div>
<?php }?>
 <?php
$cid=$_GET['editid'];
...
?>
    ...
    <p><strong>Numéro de reférence : </strong> <?php  echo $row['RefNumber'];?></p>
  <p><strong>Date d'enregistrement du dossier : </strong> <?php  echo $row['CourierDate'];?></p>
    <div class="row">                                    
<div class="col-6">
      ...
      <tr>
        <th style="text-align: center" colspan="2">Détails Client</th>
      </tr>    

   <tr>
    <th>Agence d'envoie</th>
...
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
  <tr align="center">
   <th colspan="4" >Historique du dossier</th> 
  </tr>
  <tr>
    <th>#</th>
<th>Avis</th>
...
?> 
<p align="center">                            
 <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Prendre une décision</button></p>  
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Décisions</h5>
...
<tr>
  ...
  <tr>
   ...
   <select name="status" class="form-control wd-450" required="true" >
     <option value="Courier Pickup" selected="true">Etude Analyste DG</option>
     <option value="Shipped">Etude RESA</option>
     <option value="Intransit">Etude RFC</option>
     <option value="Arrived at Destination">Etude DEX</option>
     <option value="Out for Delivery">Etude DG</option>
     <option value="Delivered" style="color: green">Décision finale</option>
   </select></td>
  </tr>
